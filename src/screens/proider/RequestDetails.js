...
const RequestDetails = ({ route: navRoute, navigation }) => {
  ...
  const handleRideStatus = useCallback(
    async status => {
      setIsLoading(true);
      try {
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        ...
        <InfoCard icon="account-circle" title="Rider">
          <Text style={styles.riderName}>{ride.userId?.name}</Text>
          {ride.userId?.email ? (
            ...
            <View style={styles.actionRow}>
              ...
              >
                {isLoading ? (
                  ...
                  <>
                    <MaterialDesignIcons name="close" size={18} color={COLORS.error} />
        ...
        {/* ── Ride Status controls (Approved only) */}
          ...
          <View style={styles.actionSection}>
            ...
            {ride.rideStatus === 'OnTheWay' && (
              ...
              >
                {isLoading ? (
                  ...
                  <>
                    <MaterialDesignIcons name="play-circle" size={20} color={COLORS.white} />
                    <Text style={styles.rideStatusBtnText}>Start Ride</Text>
                  </>
                )}
              </TouchableOpacity>
            )}
            ...
            {ride.rideStatus === 'InProgress' && (
              ...
              >
                {isLoading ? (
                  ...
                  <>
                    <MaterialDesignIcons name="flag-checkered" size={20} color={COLORS.white} />
                    <Text style={styles.rideStatusBtnText}>Complete Ride</Text>
                  </>
                )}
              </TouchableOpacity>
            )}
            ...
            <View style={styles.progressRow}>
              {['OnTheWay', 'InProgress', 'Completed'].map((s, i) => {
                ...
                const currentIdx = steps.indexOf(ride.rideStatus);
...
const styles = StyleSheet.create({
  ...
  riderName: { fontSize: FONTSIZES.lg, fontWeight: '700', color: COLORS.text, marginBottom: SIZES.xs },
